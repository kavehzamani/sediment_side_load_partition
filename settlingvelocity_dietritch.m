function [ws, wa] = settlingvelocity_dietritch(D, CSF, Pow, varargin)
%% This function calculates settling velocity of grains
% Based on the method suggestion by:  
% Dietrich, William E. "Settling velocity of natural particles." Water resources research 18, no. 6 (1982): 1615-1626.
...
% CSF is the Corey shape factor is CFS = c/sqrt(ab)
% a: long axis of grain, b: intermidiate axis of grain, c: short axis of
% grain, for circle CSF is 1
